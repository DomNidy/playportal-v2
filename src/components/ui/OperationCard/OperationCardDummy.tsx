...
export function OperationCardDummy() {
  return (
    <Link
      ...
      className="group flex h-[5.5rem] w-[21rem] flex-row items-center gap-2 rounded-2xl border border-dashed  bg-colors-background-900 px-5 py-2 pt-4 hover:bg-white/20"
    >
